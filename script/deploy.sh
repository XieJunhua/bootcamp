...
# deploy to sepolia
source .env && forge script script/NFTMarketDeploy.s.sol:NFTMarketV1Deploy --rpc-url ${ETH_RPC_URL} --broadcast --verify -vvvv
# upgrade to v2
source .env && forge script script/NFTMarketDeploy.s.sol:NFTMarketV2Deploy --rpc-url ${ETH_RPC_URL} --broadcast --verify -vvvv
